...
const eksSSOUser = "arn:aws:sts::111122223333:assumed-role/AWSReservedSSO_AdministratorAccess_0123456789abcdef/sysadmin"
...
func eksEvent(id, verb, user, accessKey string, at time.Time) string {
	extra := ""
	if accessKey != "" {
		extra = fmt.Sprintf(`,"extra":{"accessKeyId":[%q],"arn":[%q],"canonicalArn":["arn:aws:iam::111122223333:role/AWSReservedSSO_AdministratorAccess_0123456789abcdef"],"principalId":["AROA1234567890EXAMPLE"],"sessionName":["sysadmin"]}`, accessKey, user)
	}
	return fmt.Sprintf(`{"kind":"Event","apiVersion":"audit.k8s.io/v1","auditID":%q,"stage":"ResponseComplete","verb":%q,"requestURI":"/apis/apps/v1/namespaces/monitoring/daemonsets/alloy?fieldManager=kubectl-rollout","user":{"username":%q,"uid":"aws-iam-authenticator:111122223333:AROA1234567890EXAMPLE","groups":["system:authenticated"]%s},"sourceIPs":["203.0.113.10"],"userAgent":"kubectl/v1.32.2 (darwin/arm64)","objectRef":{"resource":"daemonsets","namespace":"monitoring","name":"alloy","apiGroup":"apps"},"responseStatus":{"code":200},"requestReceivedTimestamp":%q,"stageTimestamp":%q}`,
...
func TestIngest_EKSIAMPrincipalIsNeverAHuman(t *testing.T) {
	t.Parallel()
	res := ingest(t, Options{}, eksEvent("audit-1", "patch", eksSSOUser, "ASIAAGENTKEY00001", t0)+"\n")
...
func TestIngest_AccessKeySeparatesASharedPrincipal(t *testing.T) {
	t.Parallel()
	const agentKey, terraformKey = "ASIAAGENTKEY00001", "ASIATERRAFORM0001"
...
func TestIngest_CloudWatchEnvelope(t *testing.T) {
	t.Parallel()
	ev := eksEvent("audit-1", "patch", eksSSOUser, "ASIAAGENTKEY00001", t0)
...
func TestIngest_NonResourceRequestsAreNotActions(t *testing.T) {
	...
	res := ingest(t, Options{}, strings.Join([]string{
		...
		eksEvent("real-1", "patch", eksSSOUser, "ASIAAGENTKEY00001", t0.Add(time.Second)),
	}, "\n")+"\n")
